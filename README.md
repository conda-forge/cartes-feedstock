...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cartes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12224&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cartes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cartes` can be installed with:

```
conda install cartes
```

It is possible to list all of the versions of `cartes` available on your platform with:
